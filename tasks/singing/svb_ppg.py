...
class SVBPPGTask(FastSpeech2AdvTask):
    ...
    def _training_step(self, sample, batch_idx, optimizer_idx):
        # print('mel len: ', sample['mels'].shape)
        # print('mel len: ', sample['mels'].shape)
        # print('prof_mel len: ', sample['prof_mels'].shape)
        # print('txt len: ', sample['txt_tokens'].shape)
        # print('prof mel2ph', sample['prof_mel2ph'].shape)
        log_outputs = {}
        loss_weights = {}
